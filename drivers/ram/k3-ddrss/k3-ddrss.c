...
#if CONFIG_K3_DDRSS_BOARD_ADJUST
...
static int k3_msmc_set_config(struct k3_msmc *msmc)
{
	...
	/* heartbeat_per, bit[4:0] setting to Ã¢ÂÂ3Ã¢ÂÂ is advisable */
	ddr_cfg0 |= 3;
...
U_BOOT_DRIVER(k3_msmc) = {
	...
	.id = UCLASS_MISC,
	.probe = k3_msmc_probe,
	.priv_auto_alloc_size = sizeof(struct k3_msmc),
